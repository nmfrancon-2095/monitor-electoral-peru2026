...
# Semáforo: ABORDA = verde, PARCIAL = azul, TANGENCIAL = ámbar, AUSENTE = gris
# Mismos hues que COLOR_RIESGO / COLOR_BLOQUE para coherencia de paleta
# -------------------------------------------------------
COLOR_ABORDAJE = {
    "ABORDA":     "#1A7A40",   # verde  — mismo que COLOR_RIESGO_BAJO
    "PARCIAL":    "#1E6FB5",   # azul   — mismo que COLOR_ACCENT
    "TANGENCIAL": "#B86000",   # ámbar  — mismo que COLOR_RIESGO_MEDIO
    "AUSENTE":    "#5E7F96",   # gris   — mismo que COLOR_RIESGO_NONE
}
...
TIPOS_ELECCION = [
    "PRESIDENCIAL",
    "SENADORES DISTRITO \u00daNCO", "SENADORES DISTRITO MÚLTIPLE"
    "DIPUTADOS",
]
...
/* Badges de nivel de abordaje (Segunda Vuelta) */
.badge-aborda     { background: #1A7A40; color: #FFF; }
.badge-parcial    { background: #1E6FB5; color: #FFF; }
.badge-tangencial { background: #B86000; color: #FFF; }
.badge-ausente    { background: #5E7F96; color: #FFF; }
