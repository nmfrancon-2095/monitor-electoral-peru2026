...
# Semáforo: ABORDA = verde, PARCIAL = azul, TANGENCIAL = naranja, AUSENTE = gris
# -------------------------------------------------------
COLOR_ABORDAJE = {
    "ABORDA":     "#1E8A4A",
    "PARCIAL":    "#2878B5",
...
.badge-aborda     { background: #1E8A4A; color: #FFF; }
.badge-parcial    { background: #2878B5; color: #FFF; }
.badge-tangencial { background: #D4760A; color: #FFF; }
.badge-ausente    { background: #8A9BAA; color: #FFF; }
